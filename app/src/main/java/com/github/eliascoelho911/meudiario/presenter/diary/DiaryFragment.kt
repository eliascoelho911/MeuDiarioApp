...
import com.github.eliascoelho911.meudiario.presenter.common.observeOnceOnly
import com.github.eliascoelho911.meudiario.presenter.common.setOnActionExpandListener
import com.github.eliascoelho911.meudiario.presenter.common.setOnQueryTextChange
import com.github.eliascoelho911.meudiario.presenter.diary.adapter.RegistryPerDayListAdapter
import com.github.eliascoelho911.meudiario.presenter.root.RootActivityManager
...
class DiaryFragment : Fragment(), Screen {
    ...
    private fun filterRegistriesByQuery(query: String) {
        viewModel.searchRegistries(query)
            .observeOnceOnly(viewLifecycleOwner, registryPerDayListAdapter::submitList)
    }
